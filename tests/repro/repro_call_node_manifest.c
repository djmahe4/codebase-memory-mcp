...
enum {
    EXPECTED_HISTORICAL_CALL_NODE_TOTAL = 221,
    EXPECTED_ACTIVE_PRIMARY_TOTAL = 191,
...
static const CallNodeManifestEntry CALL_NODE_MANIFEST[] = {
    ...
    ENTRY(CBM_LANG_OBJECTSCRIPT_ROUTINE, "routine_tag_call", DIRECT_CALL, PRIMARY_EXTRACTOR, true,
          true),
    ENTRY(CBM_LANG_ARDUINO, "call_expression", DIRECT_CALL, PRIMARY_EXTRACTOR, true, true),
    ENTRY(CBM_LANG_ARDUINO, "new_expression", CONSTRUCTOR_CALL, PRIMARY_EXTRACTOR, true, true),
};
...
_Static_assert(MANIFEST_COUNT == EXPECTED_HISTORICAL_CALL_NODE_TOTAL,
               "call-node manifest must contain exactly 221 entries");
